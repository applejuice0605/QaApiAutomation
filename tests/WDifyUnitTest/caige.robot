...
*** Variables ***
${EXCEL_PATH}      resources/data/wa_uat/车辆信息识别测试数据.xlsx
${SHEET_NAME}      Sheet1
${CHAT_FLOW_KEY}   3bf59f50-9c02-4bc9-9982-e475f2148063
${API_BASE_URL}    https://rd-dify-sit.fuse.co.id/console/api/apps/
${authorization}   Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNTUyYmRiODktNTlkOC00NDExLWJiZmYtMjM3MGQwOWQ4MTljIiwiZXhwIjoxNzUyMTQ0OTk0LCJpc3MiOiJTRUxGX0hPU1RFRCIsInN1YiI6IkNvbnNvbGUgQVBJIFBhc3Nwb3J0In0.CzRufgJt4S7nVTVxTAPRsw9yZadhXQBdf3dhG-unSZ0
${payload}    {"bizCode":"INTENT_QUICK_ORDER_1942868218502230018","token":"eyJhbGciOiJIUzI1NiIsInppcCI6IkRFRiJ9.eNpEjM0KwjAQhN8l5xY22XSb-AIiKirqoce0rlh_YmgriuK7u_TiHL-Z-T6qf9RqoppTGHZ8S7v7haPKVArdELlbJY6zg_SLNU7X883SVVVVTGUghxj5uu-5GweOtHcI1mpLWvq6fW_vj65h6Z4i70NKf---lY8GACIDY9CXmeJXElwWltAb9JlqwzACA7YcwXloRYgEzDVAbulIueXimHs8mNyF0JCrC20Q1fcHAAD__w.GRCFD6-PxFYUFTC64Yz9WsBDCYTKiifHpsnfeCviTgU","message":"{\"brandCode\": \"MITSUBISHI\", \"vehicleManufactureYear\": \"2018\", \"brandModelCode\": \"XPANDER1.5L ULTIMAT-K 4X2AT\", \"vehicleColor\": \"PUTIH MUTIARA\", \"vehicleType\": \"MINIBUS\"}","country":"id","productCategory":"car","domain":"https://pchat-sit.fuse.co.id/api","tenantId":"1000662","messageType":2,"sys.files":[],"sys.user_id":"LP3GPKQM8YYY5G","sys.app_id":"015715de-5970-4d46-8605-e57850fbf035","sys.workflow_id":"e73f967b-fcfe-480c-8839-f04b747d0c6c","sys.workflow_run_id":"f83ca1b7-a9fd-4e66-8c0f-48d0ae73eb11"}
${column_input}    1
${column_output}    2
...
#    ${headers}=    Create Dictionary    authorization=${authorization}  Accept=*/*  Content-Type=application/json
    # 拼装字符串
    ${prefix}=    Set Variable    Bear
    ${authorization}=   Catenate    ${prefix}    ${access_token}
    Log     ${authorization}
    ${headers}=    Create Dictionary    authorization=${authorization}  Accept=*/*  Content-Type=application/json
#    ${payload}=    Set Variable   {"bizCode":"INTENT_QUICK_ORDER_1942868218502230018","token":"eyJhbGciOiJIUzI1NiIsInppcCI6IkRFRiJ9.eNpEjM0KwjAQhN8l5xY22XSb-AIiKirqoce0rlh_YmgriuK7u_TiHL-Z-T6qf9RqoppTGHZ8S7v7haPKVArdELlbJY6zg_SLNU7X883SVVVVTGUghxj5uu-5GweOtHcI1mpLWvq6fW_vj65h6Z4i70NKf---lY8GACIDY9CXmeJXElwWltAb9JlqwzACA7YcwXloRYgEzDVAbulIueXimHs8mNyF0JCrC20Q1fcHAAD__w.GRCFD6-PxFYUFTC64Yz9WsBDCYTKiifHpsnfeCviTgU","message":"{\"brandCode\": \"MITSUBISHI\", \"vehicleManufactureYear\": \"2018\", \"brandModelCode\": \"XPANDER1.5L ULTIMAT-K 4X2AT\", \"vehicleColor\": \"PUTIH MUTIARA\", \"vehicleType\": \"MINIBUS\"}","country":"id","productCategory":"car","domain":"https://pchat-sit.fuse.co.id/api","tenantId":"1000662","messageType":2,"sys.files":[],"sys.user_id":"LP3GPKQM8YYY5G","sys.app_id":"015715de-5970-4d46-8605-e57850fbf035","sys.workflow_id":"e73f967b-fcfe-480c-8839-f04b747d0c6c","sys.workflow_run_id":"f83ca1b7-a9fd-4e66-8c0f-48d0ae73eb11"}
    ${payload}=    Set Variable   {"inputs":{"bizCode":"INTENT_QUOTE_COMPARISON_1943008391542124545","token":"eyJhbGciOiJIUzI1NiIsInppcCI6IkRFRiJ9.eNpEjM0KwjAQhN8l5xY22XSb-AIiKirqoce0rlh_YmgriuK7u_TiHL-Z-T6qf9RqoppTGHZ8S7v7haPKVArdELlbJY6zg_SLNU7X883SVVVVTGUghxj5uu-5GweOtHcI1mpLWvq6fW_vj65h6Z4i70NKf---lY8GACIDY9CXmeJXElwWltAb9JlqwzACA7YcwXloRYgEzDVAbulIueXimHs8mNyF0JCrC20Q1fcHAAD__w.GRCFD6-PxFYUFTC64Yz9WsBDCYTKiifHpsnfeCviTgU","message":"${input_data}","country":"id","productCategory":"car","domain":"https://pchat-sit.fuse.co.id/api","tenantId":"1000662"},"files":[]}
    Log    ${url}
    Log    ${headers}
    Log    ${payload}
...
记录结果
    ...
    # 过滤字典数据，只取 "node_id": "1751268166882" / "title": "转成标准参数"的数据
    ...
    FOR    ${item}    IN    @{response}
        ...
        IF    ${node_id} == 1751268166882
            # 该系节点是政府车辆信息映射
            Log    ${item}[data][outputs]
            ExcelHandler.Write Cell Value    ${row_num}    ${column_output}    ${item}[data][outputs]
            BREAK
        END
