...
*** Test Cases ***
#Underwriting Workflow - Setup
#    [Tags]    uat
#    Given Setup Data Testing
#    When I have an underwriting order and have logined to Boss


[Order Review Task] I assigne the task to me and find the task in my underwriting todo list
    [Tags]    test:retry(3)     uat
    Given Setup Data Testing
    When I have an underwriting order and have logined to Boss
...
#    Given Setup Data Testing
#    When I have an underwriting order and have logined to Boss
#    Then Wait until keyword succeeds    3x    10s   [Order Review Task] I assigne the task to me and find the task in my underwriting todo list
...
I have an underwriting order and have logined to Boss
    ...
    Log     ${orderInfo}
    Set Global Variable    ${orderNo}    ${orderInfo[0]}
    Set Global Variable    ${orderId}    ${orderInfo[1]}
    Set Global Variable    ${token}


    # 调用登录Boss业务
    ${bossToken}    login.Login to Boss
    Set Global Variable    ${bossToken}
