...
${loginAccount}=  ceo001
${password}=  Fuse!001
${reduce_pointAmount}=  999998

*** Test Cases ***
Adjustment partner policy point Decrease without tax and approved Success
