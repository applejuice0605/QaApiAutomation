...
${loginAccount}=  ceo001
${password}=  Fuse!001
${reduce_pointAmount}=  100000

*** Test Cases ***
Adjustment partner policy point Decrease with tax and approved Success
    Given Login Boss Success
    Then Add New Adjustment Partner Special Bonus With Tax
    Sleep    10
...
Add New Adjustment Partner Special Bonus With Tax
    ${body}=  Set Variable    {"totalAmount":${reduce_pointAmount},"partnerCode":"99485f35","partnerName":"Partner 989","partnerMobile":"8123268989","reasonType":"other","transactionType":"policyPoint","walletAccount":"partnerSpecialBonus","flowType":"reduce","transactionAmount":${reduce_pointAmount},"calculateTaxType":"1","distributorCompanyUid":6604000375,"distributorCompany":"PT Pialang Asuransi Indotekno","growthModelCode":"Ge8Ad4nyAQ","rmName":"RM-user1","rmCode":"L5MGKYZ6GGN8Q7","uplineRmCode":"L5MGKYZ6GGN8Q7","requestId":"5a6f728d-6f20-410d-877d-7c4a709e33d0"}
