...
*** Test Cases ***
Manual Adjustment Partner Commission Decrease With Tax Approved
    [Tags]    uat
    Given Setup Data Testing
    When Login Boss Success
    Then manualAdjustment.Submit Manual Adjustment Requeqst with Tax    ${AP_POSITIVE_DATA}    ${bossToken}    ${transactionAmount}      ${flowType}     transactionType=${transactionType}
