...
${paymentScheme}    1
${paymentMethod}    VA
${discountFormCommission}      1000


*** Test Cases ***
Car PayNow PartnerPay Fullpayment using discount from Commission
    [Tags]    uat   order-car
    ...
    Then I send the place order request to createrfqorder API    ${AP_POSITIVE_DATA}     ${token}    ${rfqNo}    ${quoteNo}  ${isAdvancePremium}    discountFormCommission=${discountFormCommission}
    Then The status code should be 200    ${jsonResult}[code]
