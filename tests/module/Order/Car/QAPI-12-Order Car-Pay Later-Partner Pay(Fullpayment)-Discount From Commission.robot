...
*** Test Cases ***
Order Car-Pay Later-Partner Pay(Full payment) - Discount From Commission Success
...
Send CreateBinderOrder Post Request
    ...
    ${data}=  Send CarCreateBinderOrder Post Request - Discount From Commission  ${tenantId}  ${token}  ${quoteNo}  ${rfqNo}
