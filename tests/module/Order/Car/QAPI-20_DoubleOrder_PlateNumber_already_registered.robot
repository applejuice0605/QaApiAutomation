...
*** Test Cases ***
Motor DoubleOrder PlateNumber already registered
    ...
    Then I send the place order request to createrfqorder API using register plateNumber       ${AP_POSITIVE_DATA}     ${token}    ${rfqNo}    ${quoteNo}  ${isAdvancePremium}
