...
${paymentScheme}    1
${payerType}    2
${discountFormCommission_EQVET}     1000
...
Property EQVET PayLater With Discount Commission From EQVET
    ...
    Then I send the place order request to createrfqorder API    ${AP_POSITIVE_DATA}     ${token}    ${rfqNo}    ${quoteNo}  ${isAdvancePremium}    discountFormCommission_EQVET=${discountFormCommission_EQVET}
    Then The status code should be 200    ${jsonResult}[code]
