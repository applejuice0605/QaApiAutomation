...
Send Withdrawal Post Request
    ...
    ${body}=  Set Variable      {"accountId":"${loginAccount}","cardId":"1867170204698062850","withdrawAmount":${withdrawalAmount},"withdrawType":1,"autoTransferVersion":1,"passWord":"${password}","manuallyWithdraw":false}
