...
Send Request And Get Response Data
    ...
    [Arguments]    ${bossToken}     ${slipNo}   ${existsAssignee}=false
    # 1. 准备请求数据：请求路径、请求头、请求数据
    ${base_url}=   Set Variable     https://boss-uat.fuse.co.id
    ${path}=   Set Variable     /api/underwritingV2/list/manager
    ...
    ${payload}=    Set Variable     {"pageNo": 0,"pageSize": 20,"taskNameList": [],"multiFieldQuery": "${slipNo}","endProcess": 0,"endTask": 0,"existsAssignee": ${existsAssignee}}
    # 2. 发送请求
