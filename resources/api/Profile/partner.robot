...
${app_baseurl}  https://app-sg-uat.fuseinsurtech.com/
...
Send register_getShortLink Request And Get Response Data
    [Documentation]     https://app-sg-uat.fuseinsurtech.com/insurance-finance-vs-api/api/fuse/register/getShortLink
    ...
    ${payload}=    Set Variable    {"actualUrl": "https://app-sg-uat.fuseinsurtech.com/h5/share_register/shareRegister.html?r=${inviteCode}","inviteCode": "${inviteCode}"}}
...
Send newVerificationCode Request And Get Response Data
    [Documentation]     https://app-sg-uat.fuseinsurtech.com/insurance-finance-pre-service/pre/v2/agent/newVerificationCode
