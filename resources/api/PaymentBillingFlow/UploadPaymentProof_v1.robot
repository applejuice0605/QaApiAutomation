...
*** Variables ***
${uploadProof_url}=  https://cashier-sg-uat.fuse.co.id/api/cashier/partner/payment/bs/uploadProof
${check_taskId_url}=  https://boss-sg-uat.fuse.co.id/api/paymentBilling/list/manager
${paymentBillinAssign_url}=  https://boss-sg-uat.fuse.co.id/api/bpm/runtime/self/assign
${paymentBillinApproval_url}=  https://boss-sg-uat.fuse.co.id/api/bpm/flow/approval
${checkPaymentBillingInfo_url}=  https://boss-sg-uat.fuse.co.id/api/paymentBilling/info
*** Keywords ***
