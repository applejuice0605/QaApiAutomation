...
Send Request And Get Response Data
    ...
    ${path}=   Set Variable     /api/ticketItem/bpm/manager
    ...
    ${payload}=    Set Variable     {"pageNo":1,"pageSize":20,"transactionId":"${transactionId}","endTask":0,"endProcess":0,"existsAssignee":${existsAssignee}}
    # 2. 发送请求
