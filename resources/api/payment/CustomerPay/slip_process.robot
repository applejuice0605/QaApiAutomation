...
...    paymentScheme: 1 (FullPayment), 2 (NetPayment), 3 (SuperNetPayment), 4 (CustomerPay Fullpayment)
...
Send Request And Get Response Data
    ...
    ${payload}=    Set Variable     {"paymentScheme": ${paymentScheme},"payerType": ${payerType},"bonusDeduction": ${bonusDeduction},"orderId": "${orderId}","securityCode": "${securityCode}","selectType": 2,"pointsDeduction": ${pointsDeduction},"methodCode": ""}
